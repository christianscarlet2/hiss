...
HYPE_LINES = [
    ...
    # --- Fresh batch (rotated in 2026-06-20, Emrald: the old ones were getting old) ---
    "Modern poker is ranges, not hands. Don't ask what they have, ask what they'd do this with.",
    "Every street is a new decision. Don't marry the flop you fell for; the turn can be a divorce.",
    "Blockers are quiet power. Hold an ace, they can't have aces. Bluff the spots the math protects.",
    "Pot control is not weakness. Check back, keep it small, win at showdown. Boring chips spend fine.",
    "ICM whispers before it screams. Feel the pay jumps coming and let the short stacks bust first.",
    "A check-raise tells a story even your opponent's hero can't argue with. Save it for when it's true.",
    "Three-bet light in position, flat in the blinds. Geometry wins more pots than courage.",
    "The river is for value and for giving up. The worst bet is the one with no plan behind it.",
    "Tag the fish, then sit on their left. Money flows clockwise into the patient seat. That's yours.",
    "Don't fight the big stack for marginal chips on the bubble. Let the bully swing at someone else.",
    "Stack sizes pick your strategy for you. Read the effective stack first, the cards second.",
    "Min-cash is a floor, not a goal. Play to win it, but never spew the ladder away for a coin flip.",
    "When you're card dead, your image is your stack. Pick one clean steal and commit to the story.",
    "Limping is a leak in a tournament. Raise or fold. Let the limpers fund your raises.",
    "Slow down with one pair on a wet board. The river that completes their draw is not your friend.",
    "Aces are a hand, not a parade. Build the pot preflop so you're not guessing for stacks later.",
    "Phil Galfond says: have a reason. If you can't explain the bet out loud, don't make it.",
    "Doyle gambled, but he gambled with an edge. Aggression without a read is just donating loudly.",
    "Stu Ungar saw the cards before they fell. You can't, so play the player and the price instead.",
    "Tournament life is the only chip you can't rebuy at the final table. Spend it like it's rare.",
    "Fatigue is a leak. If your reads go fuzzy, tighten up and let the machine of your discipline play.",
    "The nut low is half a hand. In hi-lo, scoop or stay home; chopping the small end bleeds you dry.",
    "In Omaha, the nuts change on every street. The hand that flopped a monster can turn into trash.",
    "Don't barrel into the calling station's smile. Against a sticky table, value is the bluff.",
    "Respect the quiet raiser. When the table rock wakes up, your top pair goes in the museum.",
    "You are the Scarlet Beast at this table. Calm, coiled, patient -- then one clean strike. Stay coiled.",
    "Jasper's read: the chips don't remember the bad beat. Reset your face, reset your range, next hand.",
    "Win the war, not the hand. One pot lost to discipline buys ten pots won by it. Keep the long view.",
    "Tighten when tired, widen when sharp, and always know which one you are right now.",
    "The best players fold the most and bet the biggest. Do both with no hesitation and they can't read you.",
]
