...
class CHandHistoryWriter: public CVirtualSymbolEngine {
 ...
 private:
  // ---- output ----
  // (the old handhistory\complete\ + \incomplete\ file paths were removed 2026-07-16 -- the writer
  //  now persists ONLY to hiss_log_hands via p_log_writer, which feeds pt4_accumulate -> PT4)
