...
void CDlgTableMap::ApplySelectedColorPreset(bool update_region)
{
	...
	if (!text.IsEmpty()) {
		int alpha = 255;
		CString a_key;
		a_key.Format("oscolorip%da", index);
		CString alpha_text = p_tablemap->GetTMSymbol(a_key);
